...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 边角线颜色
     */
    public int mLineColor = Color.parseColor("#009688");
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x0000C4FF, Color.parseColor("#00C4FF"), 0x0000C4FF};
